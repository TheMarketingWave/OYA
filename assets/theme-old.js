    ...
    el.addEventListener("change", function (event) {
      ...
      variants.filter(function (v) {
        if (
          ...
          document
            .querySelectorAll('input[type="checkbox"].js--variant-id')
            .forEach(function (el) {
              el.value = v.id;
          ...
          // Update image
          var imageId =
            v.featured_image != null ? v.featured_image.id : default_image;
          var imageIndex = document
            .querySelector(
              '.product-image-item[data-imageid="' + imageId + '"]'
            )
...
/*
 * TOGGLE CUSTOM MENU
 * Toggles the visibility of the custom menu container in the header.
 */
